...
After Step 0, run core intake sequentially (scope boundaries, do-not-break constraints, approvals, success criteria).
Optional (non-blocking): ask onboarding special focus area.
